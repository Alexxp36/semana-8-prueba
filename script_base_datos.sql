...
-- Fecha: 2025
-- Descripción: Script completo para crear la base de datos del hospital
-- =====================================================
...
-- =====================================================
-- 1. MÓDULO DE PACIENTES Y MÉDICOS
-- =====================================================
...
-- 1. Ejecutar este script en MySQL Workbench o phpMyAdmin
-- 2. Verificar que la base de datos 'hospitaldb' se creó correctamente
-- 3. Configurar la aplicación Spring Boot con las credenciales de MySQL
-- 4. El sistema estará listo para usar con datos de prueba
--
